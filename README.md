...
- ⚙ *YOLOv8-based Detection*: Custom-trained on 3,000+ bridge images annotated for cracks, corrosion, spalling, and leakage.
- 🖼 *Streamlit UI*: Upload images and view predictions with bounding boxes and class names.
